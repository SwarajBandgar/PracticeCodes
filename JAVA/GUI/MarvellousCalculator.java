...
class Calculator extends WindowAdapter implements ActionListener
{
    ...
    public Calculator(int width,int height,String Title)
    {
        ...
        b1.setBounds(1,280,80,40);   //x,y,width,height
        ...
        t2.setBounds(180,100,80,40);

        mainframe.add(t1);
        mainframe.add(t2);

        lobj = new JLabel();
        lobj.setBounds(150,70,80,40);
    ...
    public void actionPerformed(ActionEvent obj)
    {
        try
        {
            ...
            {
              lobj.setText("Multi : "+(no1*no2));
            }
            else if(obj.getSource() == b4)
            {
              lobj.setText("Divsion is : "+(no1/no2));
            }
        }
